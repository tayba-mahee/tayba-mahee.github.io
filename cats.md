...
<div class="cat-section">
  <h2>My forever girls </h2>
  <p class="section-description">We adopted Kiki and Meelo in 2022. They have been showering us with loads of love since then.</p>
...
<!-- Kiki -->
  <div class="cat-card">
     ...
     <div class="photo-nav">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Kiki</h3>
        <div class="cat-details">
          <span class="cat-age">Young cat</span>
          <span class="cat-status adopted">✓ Adopted</span>
        </div>
        <p class="cat-story">Kiki chose us in the shelter and adopted us. She is the absolute best cat in the world.</p>
        <div class="cat-dates">📅 Adopted: 2022</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Meelo</h3>
        <div class="cat-details">
          <span class="cat-age">Young cat</span>
          <span class="cat-status adopted">✓ Adopted</span>
        </div>
        <p class="cat-story"> Meelo's mom died on the road leaving her with a sibling when they were 2 months old. A caring lady pickeup them up and that's how she ended up with us. She thinks she is a human. </p>
        <div class="cat-dates">📅 Adopted: 2022</div>
      </div>
    </div>
 </div>
...
<!-- Shelter Fosters - Adopted -->
<div class="cat-section">
  <h2>🏠 Foster Kittens </h2>
  <p class="section-description">Sweet souls who found their forever homes after staying shortly with me.</p>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Bashful, Happy & Sneezy</h3>
         <!-- <div class="cat-details">
          <span class="cat-age">Kittens</span>
          <span class="cat-status adopted">✓ Adopted</span>
        </div>  -->
        <p class="cat-story">My first batch of foster kittens who needed bottle feeding. These playful siblings needed socialization and love before finding their forever families.</p>
        <div class="cat-dates">📅 Fostered: 2025</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Gary, Chris & Mattie</h3>
        <!-- <div class="cat-details">
          <span class="cat-age">Kittens</span>
          <span class="cat-status adopted">✓ Adopted</span>
        </div> -->
        <p class="cat-story">We almost adopted Gary. He would have been our first foster fail, but we were successful. And Chris and Mattie was inseparable! They loved playing together and cuddling in a pile.</p>
        <div class="cat-dates">📅 Fostered: 2025</div>
      </div>
    </div>
  ...
  <div class="cat-card">
    <div class="cat-photos">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Woodland, Cuddlington & Farrah Pawcett</h3>
        <!-- <div class="cat-details">
          <span class="cat-age">Kittens</span>
          <span class="cat-status adopted">✓ Adopted</span>
        </div> -->
        <p class="cat-story">Three kittens with fabulous names to match their fabulous personalities! Woodland was adopted by one of our friends! </p>
        <div class="cat-dates">📅 Fostered: 2026</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <p class="cat-story">All of them were extremely cute!! Each had their own quirks and brought so much joy. They stayed for a month. </p>
        <div class="cat-dates">📅 Fostered: 2025</div>
      </div>
    </div>
  </div>
...
<!-- Rover Care -->
<div class="cat-section">
  <h2>🏡 Boarding & Sitting</h2>
  <p class="section-description">Cats I've cared for through Rover and friends, providing comfort while their families travel.</p>
  ...
  <div class="cat-card">
      <div class="cat-photos">
        ...
        <div class="cat-info">
          ...
          <div class="cat-details">
            <span class="cat-age">Young cat</span>
            <span class="cat-status boarding">Rover Guest</span>
          </div>
          <p class="cat-story">Nika is a playful young cat. She is a frequent visior and already knows all the drill.</p>
          <div class="cat-dates">📅 Boarded: 2026</div>
        </div>
  </div>
  ...
  <div class="cat-card">
      <div class="cat-photos">
        ...
        <div class="cat-info">
          ...
          <div class="cat-details">
            <span class="cat-age">Young cat</span>
            <span class="cat-status boarding">Friend's Cat</span>
          </div>
          <p class="cat-story">Our second rescue baby who we also boarded for a week.</p>
          <div class="cat-dates">📅 Boarded: 2024</div>
        </div>
  </div>
  ...
  <div class="cat-card">
      <div class="cat-photos">
        ...
        <div class="cat-info">
          <h3 class="cat-name">Wazu</h3>
          <div class="cat-details">
            <span class="cat-age">Adult cat</span>
            <span class="cat-status boarding">Neighbor's Cat</span>
          </div>
          <p class="cat-story">Wazu's parent adopted him when he lost one of his eyes. He has traveled here from all the way to Middle East. He's a fighter!</p>
          <div class="cat-dates">📅 Boarded: 2023</div>
        </div>
  </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <p class="cat-story">Simba's parent went for a Europe trip while we kept him company for a month.</p>
        <div class="cat-dates">📅 Cared for: 2025</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <p class="cat-story">Silvey came all the way from Atlanta and was rescued from a barn after a cold winter.</p>
...
<div class="cat-section">
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Mama Cat & Her Babies</h3>
        <div class="cat-details">
          <span class="cat-age">Mother with kittens</span>
          <span class="cat-status community">Community Care</span>
        </div>
        <p class="cat-story">A brave mama cat who chose my porch as a safe place to raise her kittens. We fixed all of them. They nap regularly on our porch. </p>
        <div class="cat-dates">📅 Regular Visitor since 2024</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <div class="cat-details">
          <span class="cat-age">Adult cat</span>
          <span class="cat-status community">Community Cat</span>
        </div>
        <p class="cat-story">A beautiful orange tabby (who looks exactly like Meelo)  visits regularly for meals and affection. A neighbour and her daughter named her Garfield. A friendly visitor who stops by for meals and occasional pets everyday. </p>
        <div class="cat-dates">📅 Regular visitor</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Penelope & Her Babies</h3>
        <div class="cat-details">
          <span class="cat-age">Mother with kittens</span>
          <span class="cat-status community">Community Care</span>
        </div>
        <p class="cat-story">A caring mama cat we fed daily near our apartment complex. We helped two of her babies get adopted. Unfortunately we couldn't fix her descpite much effort. </p>
        <div class="cat-dates">📅 Cared for: 2022-2024</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Ross</h3>
        <div class="cat-details">
          <span class="cat-age">Kitten</span>
          <span class="cat-status rescued">Rescued Cat</span>
        </div>
        <p class="cat-story">Ross is Penelope's daughter, who we fed for almost 2 years near our apartment. He wondered alone in a field near our house and so easy with us, we just picked her up one day and one of our friend adopted her. Fun fact: Her parents thought she was a boy, hence the name.</p>
        <div class="cat-dates">📅 Rescued: 2024</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Grumpy</h3>
        <div class="cat-details">
          <span class="cat-age">Old cat</span>
          <span class="cat-status community">Community Cat</span>
        </div>
        <p class="cat-story">Named for his perpetually grumpy expression, but actually quite gentle. We came to know he is 12 years old while we got him for fixing.</p>
        <div class="cat-dates">📅 Cared for: 2022-2024</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Hagrid</h3>
        <div class="cat-details">
          <span class="cat-age">Adult cat</span>
          <span class="cat-status community">Community Cat</span>
        </div>
        <p class="cat-story">A big, fluffy cat with a gentle giant personality - just like his namesake! He loved afternoon naps on the porch.</p>
        <div class="cat-dates">📅 Cared for: 2022-2024 </div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <p class="cat-story">A regular visitor. Cautious but warming up to regular feeding times and gentle interaction.</p>
        <div class="cat-dates">📅 2022-2024</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        <h3 class="cat-name">Baby Lucy</h3>
        <div class="cat-details">
          <span class="cat-age">Kitten</span>
          <span class="cat-status rescued">Rescued Cat</span>
        </div>
        <p class="cat-story">This is our first rescue cat, we found him crying in heavy rain. His mom was a regular visitor to ours, but less caring as a mom. We later found a forever home for him.</p>
        <div class="cat-dates">📅 2023</div>
      </div>
    </div>
  ...
  <div class="cat-card">
      ...
      <div class="cat-info">
        ...
        <p class="cat-story">A rare russian blue baby. Shy but appreciated warm churu on cold nights.</p>
        <div class="cat-dates">📅 Occasional visitor</div>
      </div>
    </div>
