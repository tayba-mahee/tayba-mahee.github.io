...
**Key Contributions:**
- Implemented CNN-based SRGAN architecture
- Developed perceptual loss function combining adversarial and content loss
...
**Impact:**
- Comprehensive overview of recent advancements in unsupervised ML for ASD diagnosis
- Guidance for future researchers in the field
...
**Key Achievements:**
- Proposed hybrid CNN-quantum circuit architecture
- Utilized dataset of over 5,000 chest X-ray images
- Achieved significant performance improvements over classical CNN
...
**Research Highlights:**
- Explored impact of feature collinearity
- Employed unsupervised dimensionality reduction with autoencoders
- Achieved up to 92% accuracy in cross-validated results
...
My research focuses on the following domains:

- **Machine Learning & Deep Learning**: Developing novel architectures for healthcare and environmental applications
- **Computer Vision**: Image processing, super-resolution, and medical image analysis
- **Quantum Computing**: Exploring quantum-classical hybrid models
